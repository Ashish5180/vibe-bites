...
couponSchema.methods.calculateDiscount = function(orderAmount, categoryItems = []) {
  let applicableAmount = orderAmount;
  
  // If coupon is category-specific, only apply to that category
  if (this.category && categoryItems.length > 0) {
